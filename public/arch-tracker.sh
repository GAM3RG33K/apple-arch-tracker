...
if [ "$OUTPUT_REPORT" = true ]; then
    ...
    # Encode the SVG logo for favicon and header
...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml;base64,LOGO_B64_PLACEHOLDER">
<style>
...
<div class="container">
  <div class="header">
    <div style="display:flex;align-items:center;gap:0.75rem">
      <img src="data:image/svg+xml;base64,LOGO_B64_PLACEHOLDER" alt="Logo" style="width:32px;height:32px;border-radius:8px">
      <div>
  ...
  <div class="footer">
    <div style="display:flex;flex-direction:column;align-items:center;gap:0.5rem">
      <a href="https://github.com/GAM3RG33K/apple-arch-tracker" target="_blank" rel="noopener noreferrer" style="display:flex;align-items:center;gap:0.5rem;color:#9ca3af;text-decoration:none;font-size:0.75rem;font-family:var(--mono);transition:color 0.15s">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
        <span>Open Source on GitHub</span>
      </a>
      <p style="font-size:0.65rem;color:#6b7280;font-family:var(--mono)">&copy; 2026 - <a href="https://harshjoshi.dev" target="_blank" rel="noopener noreferrer" style="color:#818cf8;text-decoration:none">Harshvardhan Joshi</a></p>
    </div>
  </div>
</div>
...
HTML_EOF
    ...
    sed -i '' "s|LOGO_B64_PLACEHOLDER|${LOGO_B64}|g" "$HTML_FILE"
